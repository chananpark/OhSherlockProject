...
$(document).ready(function() {
   ...
   IMP.init('imp47612337');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드".    강사님 => imp41442787
	
   // 결제요청하기
   IMP.request_pay({
       pg : 'html5_inicis', // 결제방식 PG사 구분
       pay_method : 'card',	// 결제 수단
       merchant_uid : 'merchant_chae0' + new Date().getTime(), // 가맹점에서 생성/관리하는 고유 주문번호
	   ...
	   */
		...
		*/
		...
		//  $(opener.location).attr("href", "javascript:goCoinUpdate('${requestScope.userid}','${requestScope.coinmoney}');");
            ...
            location.href="<%= request.getContextPath()%>/index.tea";  
            alert("결제에 실패하였습니다.");
            self.close();
       }
