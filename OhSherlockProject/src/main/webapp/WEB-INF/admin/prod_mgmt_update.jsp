...
<div class="container prodRegisterContainer">
	...
	<h5 style="font-weight: bold;">상품 내용 수정</h5>
	<hr>


	<form action="" name="pdReg" id="pdReg">
		<input type="checkbox"/>&nbsp;<label for="bestItem"><span>베스트 상품 여부</span></label><br>

		<label for="qnatype" class="mt-4">카테고리<span class="text-danger">*</span></label> <select
		...
		<div class="text-right" style="margin-top: 30px;">
			<input type="button" class="writeBtns" value="취소"
				...
				class="btn-secondary writeBtns" value="수정" style="margin-left: 5px;" />
		</div>
	</form>
