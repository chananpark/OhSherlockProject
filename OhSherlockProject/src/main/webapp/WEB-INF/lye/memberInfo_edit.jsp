...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("div#mobileVerify").hide(); // 처음에는 휴대전화 인증하기 클릭시 인증란을 숨기고 시작한다.
		$("span#mobileCodeConfirm").hide();  // 휴대전화 인증결과도 숨기고 시작한다.
		$("div#emailVerify").hide();  // 처음에는 이메일 인증하기 클릭시 인증란을 숨기고 시작한다.
		$("span#emailCodeConfirm").hide();  // 이메일 인증결과도 숨기고 시작한다.
		$("#spinner").hide();        // 휴대전화 스피너 숨기고 시작
		$("#spinner2").hide();       // 이메일 스피너 숨기고 시작
	...
	function mobileVerifyCodeCheck() {
		...
		const userVerifyCode = $("input#mobileCode").val();
			...
			b_flag_mobileVerifyCode_click = true;  
	...
	<div class="collapse show">
		<table class="table table-bordered mt-2 orderInfo">
			...
			<thead class="thead-light">
				...
				<tr>
					<th style="vertical-align: middle">휴대전화<span class="mustIn">*</span></th>
					<td>
