...
public class ProductVO {
	...
	*/
	...
	// 상품 등록
	public ProductVO(int pnum, String pname, String pimage, String prdmanual_systemfilename,
            String prdmanual_orginfilename, int pqty, int price, int saleprice, int fk_snum,
            String pcontent, String psummary, int point, String pinputdate, int fk_cnum) {
	   this.pnum = pnum;
	   this.pname = pname;
	   this.pimage = pimage;
