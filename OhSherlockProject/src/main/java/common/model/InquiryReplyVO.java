...
public class InquiryReplyVO {
	...
	public InquiryReplyVO(int inquiry_no, String fk_userid, String inquiry_cat, String inquiry_subject,
			String inquiry_content, String inquiry_date, int inquiry_answered, int inquiry_email, int inquiry_sms) {
		super();
		this.inquiry_no = inquiry_no;
		this.fk_userid = fk_userid;
		this.inquiry_cat = inquiry_cat;
	...
	public String getInquiry_cat() {
		return inquiry_cat;
	}
	public void setInquiry_cat(String inquiry_cat) {
		this.inquiry_cat = inquiry_cat;
	}
