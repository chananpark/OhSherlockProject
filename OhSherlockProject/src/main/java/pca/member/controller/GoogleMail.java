...
public class GoogleMail {
	...
	public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws MessagingException {
		// 1. 정보를 담기 위한 객체
        Properties prop = new Properties(); 
        
        // 2. SMTP(Simple Mail Transfer Protocoal) 서버의 계정 설정
           //    Google Gmail 과 연결할 경우 Gmail 의 email 주소를 지정 
        prop.put("mail.smtp.user", "hello.world9709@gmail.com");
        ...
        // 제목 설정
        String subject = "[오!셜록] "+name+"님의 주문이 성공했습니다.";
        msg.setSubject(subject);
                
        // 보내는 사람의 메일주소
        String sender = "hello.world9709@gmail.com";
        Address fromAddr = new InternetAddress(sender);
        msg.setFrom(fromAddr);
