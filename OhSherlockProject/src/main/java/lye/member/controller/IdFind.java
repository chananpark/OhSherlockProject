...
String method = request.getMethod();   // "GET" 또는 "POST"
		...
		request.setAttribute("method", method);   // "GET" 또는 "POST"
		
	//	super.setRedirect(false);   // default 값을 false 로 주었음.
		super.setViewPage("/WEB-INF/login/idFind.jsp");  // view단 페이지(.jsp) 로 다시 넘겨준다. - forward 방식
	}
